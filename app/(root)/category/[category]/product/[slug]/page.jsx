                ...
                <div className="flex flex-col gap-y-4 md:gap-y-6 lg:w-[55%] lg:gap-y-8">
                  ...
                  <div className="flex flex-col gap-y-1 lg:gap-y-2">
                    ...
                    <div className="flex gap-x-4">
                      <Quantity
                        plantQuantity={product.quantity}
                        className="flex-1"
                      />
                      <AddToCartButton plant={product} className="flex-1" />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="space-y-8">
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm opacity-60 md:text-base lg:text-lg xl:text-xl">
                          The {product.name} I ordered arrived in perfect
                          condition. Its unique shape adds a nice touch to my
                          plant collection!
                        </p>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm opacity-60 md:text-base lg:text-lg xl:text-xl">
                          Looks stunning! The colors are so vibrant, and the
                          plant was packed very well.
                        </p>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm opacity-60 md:text-base lg:text-lg xl:text-xl">
                          The pot color and shape are so cute, and the plant is
                          just the right size. Definitely happy with my
                          purchase.
                        </p>
                      </div>
