...
export default function Footer() {
  return (
    <footer className="relative bg-button/10 p-8">
      <div className="absolute right-8 top-8 flex size-9 cursor-pointer rounded-full bg-button lg:right-16 xl:right-40">
        <Link href="#home" className="flex w-full items-center justify-center">
          <ArrowUpIcon />
        </Link>
      </div>
      <div className="container mx-auto max-w-[1280px]">
        <div className="flex flex-col justify-between gap-y-8 md:p-10 lg:flex-row lg:p-16">
        ...
        <div>
          ...
          <p className="pt-8 text-center text-sm opacity-60 md:text-base lg:text-lg xl:text-xl">
            &#169; All rights reserved.
          </p>
        </div>
      </div>
