      ...
      <div className="flex flex-row items-center justify-center gap-12 max-[460px]:flex-col md:text-xl lg:text-2xl xl:text-3xl">
        <div className="space-y-4">
          <div className="relative size-52 bg-[url('/assets/all-bg.svg')] bg-cover md:size-64 lg:size-80">
            <Image
              className="absolute left-8 top-8 size-24 drop-shadow-sm md:size-32 md:drop-shadow-md lg:size-40 lg:drop-shadow-lg"
            ...
            />
            <Image
              className="absolute bottom-8 right-8 size-24 drop-shadow-sm md:size-32 md:drop-shadow-md lg:size-40 lg:drop-shadow-lg"
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <div className="flex size-40 items-center justify-center bg-[url('/assets/cactus-bg.svg')] bg-cover md:size-52 lg:size-60">
              <Image
                className="size-24 drop-shadow-sm md:size-32 md:drop-shadow-md lg:drop-shadow-lg"
